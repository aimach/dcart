...
import TileLayerWithFallback from "../tileLayerWithFallback/TileLayerWithFallback";
        ...
        <section className="leaflet-container">
          ...
          <section
            aria-label={`Carte interactive ${
              mapInfos?.[`title_${language}`] ?? `Carte d'exploration`
            }`}
          ...
          >
            <MapContainer
              ...
              ref={setMap}
              key={`${isReset.toString()} - ${language}`} // pour forcer le rechargement de la carte lors du reset et du changement de langue
            >
