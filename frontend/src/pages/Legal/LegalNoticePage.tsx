		...
		<div className={style.legalPage}>
			...
			<div className={style.paragraphContainer}>
				...
				<p>
					...
					Santé). Ce projet vise à diffuser les données et connaissances qui ont
					été produites dans le cadre du projet de recherche{" "}
					<a href="https://map-polytheisms.huma-num.fr/">ERC MAP</a>, à
					destination d'un public non spécialiste. Il mobilise les possibilités
					du web pour diffuser des contenus attractifs (Atlas numérique des noms
			...
			<div className={style.paragraphContainer}>
				...
				<p>
					...
					<br />
					<br />
					<a href="https://github.com/aimach" target="_blank" rel="noreferrer">
						github.com/aimach
					</a>
					<br />
				</p>
			...
			<div className={style.paragraphContainer}>
				...
				<p>
					...
					https://dcart-map.huma-num.fr/ s’engage à mettre en œuvre les mesures
					adéquates à la protection, la confidentialité et la sécurité des
					Données Personnelles conformément à la réglementation en vigueur en
					France et dans l’Union Européenne, en particulier au Règlement Général
					sur la Protection des Données Personnelles UE 2016/679 du 27 avril
					2016 et aux règles de droit national prises pour son application.
					<br />
				...
				<p>
					...
					<p>
						Via le site web, nous traitons des données à caractère personnel qui
						vous concernent. Nous considérons que ces données proviennent
						directement de vous-même. Dans tous les cas, vous êtes informés des
						finalités pour lesquelles vos données sont collectées par nos soins
						via les différents formulaires de collecte de données en ligne ou
						bien encore via notre Politique des cookies. Vos données à caractère
						personnel collectées sur ce site sont traitées conformément aux
						finalités prévues lors de la collecte, dans le respect du RGPD et
						des lignes directrices de la CNIL.
					</p>
				</p>
				<p>
					...
					<p>
						...
						personnelles peuvent être traitées dans le cadre de cette activité,
						notamment pour : <br />- permettre l’accès à votre compte
						utilisateur ;<br />- garantir la sécurité de l’authentification et
						de la session ;<br />- vous fournir des services personnalisés liés
						à votre profil. <br />
						...
						suppression complète de votre compte, entraînant l’effacement de vos
						données personnelles associées, sauf obligation légale de
						conservation.
					</p>
					...
					<p>
						...
						<br />
						Ces données sont traitées dans le but de : <br />- afficher l’auteur
						de la carte publiée <br />- valoriser la contribution individuelle
						des utilisateurs <br />- assurer la traçabilité éditoriale des
						contenus proposés sur la plateforme
						<br />
						<br />
						...
						demander :<br /> - la modification de vos données affichées, <br />-
						leur suppression si vous ne souhaitez plus qu’elles soient visibles
						publiquement.
					</p>
				</p>
				<div className={style.paragraphContainer}>
					...
					<p>
						...
						fonctionnement du site. Aucun cookie publicitaire ou de mesure
					...
					<p>
						...
						maintenir votre session active et sécurisée. Ce cookie : <br />- est
						essentiel pour le fonctionnement du système de connexion ;
					...
					<p>
						...
						offre l’opportunité de modifier ces paramètres standards de manière
						que l’ensemble des cookies soit rejeté systématiquement ou bien à ce
						qu’une partie seulement des cookies soit acceptée ou refusée en
						fonction de leur émetteur.
					</p>
				</div>
				<div className={style.paragraphContainer}>
